...
class TestGetInfo:
    ...
    def test_has_essential_config_fields(self):
        """The wizard-exposed config fields are the 4 essentials.
        ...
        context_window is included so the wizard can surface the kernel
        budget knob (PR 2: feat/context-window-config).
        """
        expected_field_ids = {
            "api_key",
            "base_url",
